...
internal readonly record struct CountryInfo : IEquatable<string>, ICountryInfo
{
    ...
    public CountryInfo(string countryInfoEntry)
    {
        ...
        if (fields.Length != fieldCount) throw new ArgumentException("Invalid countryInfo Record");
    ...
    //{
    //    if (obj is CountryInfo info) return info.Iso == Iso;
