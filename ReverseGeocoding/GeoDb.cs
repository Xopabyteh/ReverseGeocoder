...
public class GeoDb
{
    ...
    private static IReadOnlyList<IPlaceInfo> GetPlaces(Stream input,
        IReadOnlyDictionary<string, ICountryInfo> countryInfos)
    {
        ...
        {
            if (line.StartsWith(commentMark)) continue;

            var place = new PlaceInfo(line, countryInfos);
    ...
    private static IReadOnlyList<IPlaceInfo> GetPlaces(string placesDbPath,
        IReadOnlyDictionary<string, ICountryInfo> countryInfos)
    {
