...
public class ReverseGeocoderTests
{
    ...
    private static string PlacesDbPath => Path.Combine(TestContext.CurrentContext.TestDirectory, k_PlacesDb);
    private static string CountryInfoDbPath => Path.Combine(TestContext.CurrentContext.TestDirectory, k_CountryInfoDb);
    ...
    public void SetUp()
    {
        preSetupReverseGeocoder = new ReverseGeocoder(PlacesDbPath, CountryInfoDbPath);
    }
    ...
    {
        IReverseGeocoder sut = new ReverseGeocoder(PlacesDbPath);
    ...
    {
        IReverseGeocoder sut = new ReverseGeocoder(PlacesDbPath, CountryInfoDbPath);
        var place = sut.GetNearestPlace(latitude, longitude);
    ...
    {
        using var fileStream = File.OpenRead(PlacesDbPath);
    ...
    {
        using var fileStreamCities = File.OpenRead(PlacesDbPath);
        using var fileStreamCountries = File.OpenRead(CountryInfoDbPath);
    ...
    {
        var sut = new GeoDb(PlacesDbPath);
    ...
    {
        var sut = new GeoDb(PlacesDbPath, CountryInfoDbPath);
    ...
    {
        IReverseGeocoder sut
            = new ReverseGeocoder(PlacesDbPath);
